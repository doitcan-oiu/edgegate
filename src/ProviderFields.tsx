...
export function ProviderFields({ value, onChange, discovery, onLoadingChange, readOnly = false, ref }: {
  ...
  return <>
    ...
    <Field label="服务商模型清单" hint="输入模型 ID 后按回车添加，也可粘贴多行或用逗号分隔。最多 1000 个，自动去重；保存后自动建立同名路由。">
